...
RSpec.describe "day2_awts/new", type: :view do
  before(:each) do
    assign(:day2_awt, Day2Awt.new(
  ...
  it "renders new day2_awt form" do
    render

    assert_select "form[action=?][method=?]", day2_awts_path, "post" do
